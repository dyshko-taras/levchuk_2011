...
- [ ] **Фаза 13 — Settings**
  ...
  - [x] Date defaults (Today/Yesterday/Tomorrow).
  - [x] Notifications: goal alerts / final alerts / pre-game reminders (глобальні toggles).
...
- [ ] **Фаза 15 — Нотифікації (локальні)**
  ...
  - [x] Додати сервіс планування локальних нотифікацій (WorkManager + flutter_local_notifications).
  - [ ] Реалізувати правила:
